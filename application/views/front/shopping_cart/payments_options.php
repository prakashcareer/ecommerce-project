    ...
    <?php
        ...
        $rzp_set = $this->db->get_where('business_settings',array('type' => 'rzp_set'))->row()->value;
...
<div class="row">
            ...
            if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){
                ...
                <!--<div class="cc-selector col-sm-3">
                    ...
                    <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; " for="mastercard" onclick="radio_check('mastercard')">
                        <img src="<?php echo base_url(); ?>template/front/img/preview/payments/upi.jpg" width="100%" height="100%" style=" text-align-last:center;" alt="<?php echo translate('cash_on_delivery');?>" />
    ...
    if ($rzp_set == 'ok') {
      ...
      $razorpay_key =  "rzp_test_MKwlcDUsYSKNkk"; ?>
?>
    ...
    <div class="cc-selector col-sm-3">
        <input id="razorpay" type="radio" style="display:block;" name="payment_type" value="razorpay"/>
        <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden;" for="razorpay">
            <img src="<?php echo base_url(); ?>template/front/img/preview/payments/upi.jpg" width="100%" height="100%" style="text-align-last:center;" alt="<?php echo translate('razorpay');?>" />
        </label>
    </div>
    ...
    <script>
        ...
        var options = {
            ...
            "amount": "<?php echo $grand * 100; ?>", // Amount in paise
            "currency": "<?php echo currency_code(); ?>",
            "name": "<?php echo $system_title; ?>",
            "description": "<?php echo translate('razorpay'); ?>",
